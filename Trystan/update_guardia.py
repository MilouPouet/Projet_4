...
BASE_DIR = "GuardiaUltimate"
print(f"🚑 RÉPARATION DU CRASH INSCRIPTION (CENTRALISATION)...")

# --- 1. DATA MANAGER (Ajout fonction register_user) ---
CODE_DATA = r'''import csv
import os
import json
import shutil
import webbrowser
...
# --- 2. GUI (Utilisation du DataManager pour Register) ---
CODE_GUI = r'''import sys
import os
import io
import json
import qrcode
...
# --- ECRITURE ---
print("⚙️ Mise à jour data_manager.py (Fonction register_user)...")
with open(os.path.join(BASE_DIR, "src", "data_manager.py"), "w", encoding="utf-8") as f: f.write(CODE_DATA)

print("⚙️ Mise à jour main.py (Utilisation register_user + Try/Except)...")
with open(os.path.join(BASE_DIR, "main.py"), "w", encoding="utf-8") as f: f.write(CODE_GUI)

print("\n✅ RÉPARATION TERMINÉE.")
print("👉 Lance 'python main.py' et essaie de t'inscrire à nouveau.")